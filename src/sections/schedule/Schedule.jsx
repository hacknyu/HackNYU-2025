    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="w-[1280px] p-[80px] bg-[#0b5cd5] rounded-tl-[85px] rounded-tr-[85px] flex justify-between items-start gap-[120px]">
          ...
          <div className="w-[50%]">
            <div className="pb-[20px] border-b border-white">
              <h3 className="text-white text-xl font-bold font-['Inter']">Saturday</h3>
            </div>
            <div className="py-[16px] border-b border-white flex items-start">
              <div className="w-[150px] text-white text-xl font-bold font-['Inter'] flex-shrink-0">9:00 AM</div>
            ...
            <div className="py-[16px] border-b border-white flex">
              <div className="w-[150px] text-white text-xl font-bold font-['Inter']">10:00 AM</div>
              <div className="text-white text-base font-normal font-['Inter'] leading-relaxed">
                Light Breakfast
              </div>
            </div>
            <div className="py-[16px] border-b border-white flex">
              <div className="w-[150px] text-white text-xl font-bold font-['Inter']">12:00 PM</div>
              <div className="text-white text-base font-normal font-['Inter'] leading-relaxed">
                Team Formation
              </div>
            </div>
            <div className="py-[16px] border-b border-white flex">
              <div className="w-[150px] text-white text-xl font-bold font-['Inter']">12:30 PM</div>
              <div className="text-white text-base font-normal font-['Inter'] leading-relaxed">
                Workshop One
              </div>
            </div>
            <div className="py-[16px] border-b border-white flex">
              <div className="w-[150px] text-white text-xl font-bold font-['Inter']">14:00 PM</div>
              <div className="text-white text-base font-normal font-['Inter'] leading-relaxed">Lunch</div>
            </div>
            <div className="py-[16px] border-b border-white flex">
              <div className="w-[150px] text-white text-xl font-bold font-['Inter']">17:30 PM</div>
              <div className="text-white text-base font-normal font-['Inter'] leading-relaxed">
                Snacks and Fun-tivity
              </div>
            </div>
            <div className="py-[16px] border-b border-white flex">
              <div className="w-[150px] text-white text-xl font-bold font-['Inter']">21:00 PM</div>
              <div className="text-white text-base font-normal font-['Inter'] leading-relaxed">Dinner</div>
            </div>
          </div>
          ...
          <div className="w-[50%]">
            <div className="pb-[20px] border-b border-white">
              <h3 className="text-white text-xl font-bold font-['Inter']">Sunday</h3>
            </div>
            <div className="py-[16px] border-b border-white flex">
              <div className="w-[150px] text-white text-xl font-bold font-['Inter']">9:30 AM</div>
              <div className="text-white text-base font-normal font-['Inter'] leading-relaxed">Brunch</div>
            </div>
            <div className="py-[16px] border-b border-white flex">
              <div className="w-[150px] text-white text-xl font-bold font-['Inter']">11:30 AM</div>
              <div className="text-white text-base font-normal font-['Inter'] leading-relaxed">
                Project Deadline
              </div>
            </div>
            <div className="py-[16px] border-b border-white flex">
              <div className="w-[150px] text-white text-xl font-bold font-['Inter']">15:00 PM</div>
              <div className="text-white text-base font-normal font-['Inter'] leading-relaxed">
                Closing Ceremony
              </div>
            </div>
      ...
      <div className="flex justify-center items-center min-h-screen bg-white mb-12">
        <div class="w-[1280px] h-[1023.07px] relative bg-white  overflow-hidden">
          ...
          <div class="w-[227.91px] h-[48.46px] left-[293.53px] top-[133px] absolute">
              <div class="w-[227.91px] h-[48.46px] left-0 top-0 absolute bg-[#0b5cd5] rounded-[27.88px]"></div>
              <div class="w-[120.28px] left-[53.47px] top-[12px] absolute text-center text-white text-lg font-semibold font-['Inter']">Tandon Gym</div>
          </div>
          ...
          <div class="w-[227.72px] h-28 left-[294px] top-[388px] absolute">
              ...
              <div class="w-[220.41px] h-[50.84px] left-[1px] top-[48px] absolute text-center text-[#0b5cd5] text-lg font-semibold font-['Inter']">Judging</div>
          </div>
          ...
          <div class="w-[175px] h-[81px] left-[952px] top-[250px] absolute">
              <div class="w-[175px] h-[67.53px] left-0 top-0 absolute bg-white rounded-[21px] border border-[#0b5cd5]"></div>
              <div class="w-[165.31px] h-[58.75px] left-[5px] top-[22.25px] absolute text-center text-[#0b5cd5] text-lg font-semibold font-['Inter']">Brunch</div>
          </div>
          <div class="w-[0.66px] h-[0.66px] left-[733.03px] top-[282.58px] absolute"></div>
          <div class="w-[205.81px] h-[578.26px] left-[302.16px] top-[394.11px] absolute rounded-[33.20px]"></div>
